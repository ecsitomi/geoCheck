...
with col2:
    ...
    with st.expander("🎯 OKTATÓANYAG ℹ️"):
        # 1. BEVEZETÉS
        with st.expander("📚 **1. BEVEZETÉS - Mi az a GEO?**"):
...
st.markdown(
    """
    <p style='text-align: center;'>🚀 <b>GEOcheck</b> | AI & ML támogatott generatív engine optimalizált website ellenőrző rendszer | Fejlesztette: Ecsedi Tamás | 2025</p>
    """,
